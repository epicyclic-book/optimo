...
config = {
  ...
  'num_obj': 14,
  'num_constr': 15,
  'bounds_min': [10, 20, 50, 0.0, -0.5, 0.0, 3, 2],
  'bounds_max': [20, 30, 60, 1.0,  0.5, 1.0, 5, 6],
  'ref_data': [15, 24, 56, 0.57, -0.042, 0.1, 4, 5],
...
def Problem(v, obj, con):
  ...
  sigma_H1 = math.sqrt((F_t1 * (i1 + 1)) / (d_w2 * b * i1)) * Z_H1 * Z_eps1 * sigma_H
